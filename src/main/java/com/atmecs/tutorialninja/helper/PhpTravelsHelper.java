...
public class PhpTravelsHelper {
	Pageactions page;
	LogReport log;
	ReadLocatorsFile read;
	public WebDriver driver;
	
	public PhpTravelsHelper(WebDriver driver)
	{
		this.driver=driver;
	}
	public void performAction(WebDriver driver,String expectedData,String validationMessage) throws Exception
	{
		...
		log=new LogReport();
        read=new ReadLocatorsFile(driver);
		String actualproduct;
        actualproduct=page.getText(ReadLocatorsFile.getData(validationMessage,ProjectBaseConstantPaths.PHPTRAVELS_FILE));
